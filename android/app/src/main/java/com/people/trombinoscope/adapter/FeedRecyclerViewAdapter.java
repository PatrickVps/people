...
import com.people.trombinoscope.fragments.dummy.DummyContent.DummyItem;
...
public class FeedRecyclerViewAdapter extends RecyclerView.Adapter<FeedRecyclerViewAdapter.ViewHolder> {
    ...
    public FeedRecyclerViewAdapter(List<DummyItem> items, IOnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
